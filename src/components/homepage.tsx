...
export function HomePage() {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    // Set results to empty to show loading state
    setSearchResults([]);
    ...
    try {
      ...
      if (success && data && data.results) {
        ...
        setSearchResults(
          fatwas.map((item: FatwaSearchResult) => ({
          ...
          <div className="flex flex-col space-y-4 py-4">
            ...
            >
              ...
              >
                ...
                <path
                  fill="#4A90E2"
                  d="M19.834192,20.9995801 C22.0291676,18.9520994 23.4545455,15.9157113 23.4545455,12 C23.4545455,11.2909091 23.3454545,10.5272727 23.1818182,9.81818182 L12,9.81818182 L12,14.4545455 L18.4363636,14.4545455 C18.1187732,16.013626 17.2662994,17.2212117 16.0407269,18.0125889 L19.834192,20.9995801 Z"
                />
                <path
                  fill="#FBBC05"
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {userSearchInfo.tier === "free"
                ...
                : "Anda telah mencapai had carian premium. Naik taraf ke pelan Tanpa Had."}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-6 py-4">
            {userSearchInfo.tier === "free" ? (
                ...
                <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-100 flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-medium text-sm">
                      Had Pelan Percuma Dicapai
                    </h4>
                    <p className="text-sm text-gray-600 mt-1">
                      Anda telah menggunakan {userSearchInfo.searchCount}{" "}
                      daripada 3 carian yang tersedia pada pelan percuma.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-100 flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-medium text-sm">
                    Had Pelan Premium Dicapai
                  </h4>
                  <p className="text-sm text-gray-600 mt-1">
                    Anda telah menggunakan {userSearchInfo.searchCount} daripada
                    20 carian yang tersedia pada pelan premium.
                  </p>
                </div>
              </div>
            )}
            ...
            <div className="space-y-4 bg-emerald-50 p-4 rounded-lg border border-emerald-100">
              ...
              <div className="pt-2 space-y-3">
                <p className="text-sm text-gray-600">
                  Untuk naik taraf, sila hubungi kami melalui salah satu cara
                  berikut:
                </p>
      ...
      <Dialog open={showUserStatsModal} onOpenChange={setShowUserStatsModal}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Ringkasan carian dan penggunaan akaun{" "}
              {userSearchInfo.tier === "premium" ? "Premium" : "Tanpa Had"} anda
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            <Button type="button" onClick={() => setShowUserStatsModal(false)}>
              Tutup
            </Button>
          </DialogFooter>
        </DialogContent>
        ...
        {!isSearching ? (
          <div className="text-center">
            ...
            {session && userSearchInfo.tier === "free" && (
              <div className="max-w-md mx-auto mb-8 bg-white rounded-lg p-4 shadow-sm">
                ...
                <Progress
                  value={(userSearchInfo.searchCount / 3) * 100}
                  className="h-2"
                />
            ...
            >
              <div className="relative group">
                ...
                <Button
                  ...
                  disabled={
                    !query.trim() ||
                    (!!session && userSearchInfo.isLimitReached)
                  }
          ...
          <div className="space-y-8">
            ...
            {searchResults.length > 0 ? (
              ...
              <div>
                <h2 className="text-2xl font-semibold text-gray-900 px-1 mb-4">
                  Hasil Teratas
                </h2>
              ...
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Kami sedang mencari koleksi fatwa yang disahkan untuk
                      mencari jawapan yang paling relevan untuk anda.
                    </p>
                  </div>
                </div>
              </CardContent>
